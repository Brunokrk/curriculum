...
import 'package:portfolio_webapp/app/widgets/flip_photo_card.dart';
...
class Header extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      padding:
          EdgeInsets.symmetric(vertical: isMobile ? 60 : 80, horizontal: 20),
      child: isMobile
          ? Column(
              ...
              children: [
                const FlipPhotoCard(
                  ...
                  avatar: 'assets/images/icon-removebg-preview.png',
                    ...
                    children: [
                      ...
                      SelectableText(
                        ...
                        style: Theme.of(context)
                            ...
                            ?.copyWith(
                              color:
                                  CustomTheme.secondaryColor.withOpacity(0.9),
                              fontSize: 20,
                              fontWeight: FontWeight.w400,
                              letterSpacing: 0.5,
                            ),
