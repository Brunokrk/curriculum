...
class Constants {
  String aboutSec =
      "Me chamo Bruno Marchi Pires, tenho 24 anos e atualmente resido na cidade de Florianópolis. Sou formado em Ciência da Computação na Universidade do Estado de Santa Catarina (UDESC). "
  ...
  static List<Project> getProjects(AppLocalizations l10n) {
    return [
      Project(
        ...
        githubUrl:
            'https://github.com/Brunokrk/Learning_Firebase_with_Flutter/tree/main',
      ),
      Project(
        id: '2',
